...
export default React.createClass({
  ...
  getChatLogItems(){
    ...
    xhr.open("GET", "http://tiny-tiny.herokuapp.com/collections/maxamey-chat-app-normal-mode");
    xhr.send();
  },
  ...
  onSubmitChatHandler(e){
    ...
    xhr.open("POST", "http://tiny-tiny.herokuapp.com/collections/maxamey-chat-app-normal-mode");
